window.onload = function() {
  ...
  document.getElementById('footer6-3v').remove();
...
<section data-bs-version="5.1" class="footer6 cid-uKO2P6Ij1V" once="footers" id="footer6-3v">
      <div class="container">
          <div class="row content mbr-white">
              ...
              <div class="col-12 col-md-3 mbr-fonts-style display-7">
                  ...
                  <ul class="list mbr-fonts-style mb-4 display-4">
                      <li class="mbr-text item-wrap"><a href="https://www.instagram.com/samirono_emas?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="text-white text-primary" target="_blank">Instagram SDN Samirono</a></li>
                      <li class="mbr-text item-wrap"><a href="https://youtube.com/@sdnsamirono_official?si=qrXq16gKyIpEeSNP" class="text-white" target="_blank">Youtube SDN Samirono</a></li>
                  </ul>
              ...
              <div class="col-md-6">
                  <div class="social-list align-left">
                      <div class="soc-item">
                          <a href="https://www.instagram.com/samirono_emas?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank">
                      ...
                      <div class="soc-item">
                          <a href="https://youtube.com/@sdnsamirono_official?si=qrXq16gKyIpEeSNP" target="_blank">
		...
		<a href="https://respati.ac.id/" target="_blank">
        		<img src="assets/images/logo-unriyo-baru.png-561x561.png" alt="Logo" style="width: 50px;">
    		</a>
